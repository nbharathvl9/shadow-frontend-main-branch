            ...
            <div className="max-w-4xl mx-auto px-4 py-6 pb-24">
                ...
                <div className="flex gap-3 mb-6">
                    <button
                        ...
                        className={`flex-1 py-3 rounded-md border transition text-sm font-medium ${showCalendar
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 rounded-md border transition text-sm font-medium ${isEditing
